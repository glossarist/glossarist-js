...
export const CONCEPT_TYPE = Object.freeze({
  GENERAL: 'general',
  INDIVIDUAL: 'individual',
});

export const CONCEPT_TYPE_VALUES = Object.freeze(Object.values(CONCEPT_TYPE));

export const DEFAULT_CONCEPT_TYPE = CONCEPT_TYPE.GENERAL;

export function isValidConceptType(value) {
  return CONCEPT_TYPE_VALUES.includes(value);
}
